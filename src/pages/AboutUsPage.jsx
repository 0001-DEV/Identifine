    ...
    <div className="bg-[#EBEAE6] min-h-screen pt-36 sm:pt-44 pb-24 px-6 sm:px-12 text-[#111111] overflow-hidden">
      <div className="max-w-7xl mx-auto space-y-[10rem] sm:space-y-[13.5rem] lg:space-y-[16rem]">
        ...
        <section className="space-y-14 py-4">
          {/* Header: Badge on left aligned with line 1 of Turning vision into heading */}
          <div className="scroll-reveal flex flex-col lg:flex-row lg:items-start justify-between gap-6 lg:gap-12">
            <div className="inline-flex items-center justify-start gap-2 pt-2 sm:pt-3.5 shrink-0">
              <img
                src={starIcon}
                alt=""
            ...
            <h2 className="text-5xl sm:text-7xl lg:text-[5.5rem] font-galano font-medium text-[#111111] leading-[1.08] text-left max-w-4xl lg:ml-[250px]">
