...
export default function AboutUsPage() {
  ...
  return (
    <div className="bg-[#EBEAE6] min-h-screen pt-36 sm:pt-48 pb-28 px-6 sm:px-12 text-[#111111] overflow-hidden">
      <div className="max-w-7xl mx-auto space-y-32 sm:space-y-40">
        
        {/* ========================================================= */}
        {/* 1. HERO & THE IDENTIFINE STORY SECTION                    */}
        {/* ========================================================= */}
        <section className="space-y-16 w-full pt-8">
          
          {/* Main Hero Header - 3 Lines Bold Far Left Aligned */}
          <div className="scroll-reveal space-y-1 text-left w-full">
            <h1 className="text-5xl sm:text-7xl lg:text-[6.25rem] font-galano font-bold tracking-tight text-[#111111] leading-[1.06] text-left">
              <span className="block">
                We craft <em className="font-swarsh italic font-normal text-[#111111] px-1.5">identity</em>
              </span>
          ...
          {/* Story Narrative Section - Center Aligned */}
          <div className="scroll-reveal space-y-8 max-w-4xl mx-auto pt-8 text-center">
            <div className="inline-flex items-center justify-center gap-2.5 mx-auto">
              ...
              />
              <span
                className="font-galano font-medium text-xs sm:text-sm text-[#111111] tracking-widest uppercase"
            ...
            <div className="space-y-6 text-base sm:text-lg lg:text-[1.2rem] text-[#333333] leading-relaxed font-normal text-center max-w-3xl mx-auto">
              <p>
              ...
              <p>
                Through our Identity Transformation Journey, <strong className="text-[#111111] font-semibold">Discover. Design. Deploy. Evolve.</strong>, and our <strong className="text-[#111111] font-semibold">5P Identity Framework</strong> spanning <strong className="text-[#111111] font-semibold">Purpose, People, Places, Processes, and Presence</strong>, we help organizations turn identity into a strategic advantage, because every organization tells a story. The question is whether that story is being told by design... or by default.
              </p>
            </div>
          ...
          <div className="max-w-[84rem] mx-auto space-y-12">
            ...
            <div className="scroll-reveal space-y-3 text-center max-w-4xl mx-auto">
              <div className="inline-flex items-center justify-center gap-2.5 mx-auto">
                ...
                />
                <span
                  className="font-galano font-medium text-xs sm:text-sm text-white/90 normal-case"
            ...
            {/* Team Grid Layout - Slightly reduced width and height for refined proportion */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr] gap-3 sm:gap-3.5 lg:gap-4 auto-rows-fr items-stretch">
              {teamMembers.map((member, idx) => (
                <div
                  key={member.id}
                  className={`scroll-reveal group relative rounded-[28px] overflow-hidden bg-[#111111] border border-[#222222] shadow-md transition-all duration-500 hover:border-[#E2B857]/40 hover:shadow-2xl ${
                    idx === 0
        ...
        <section className="space-y-14">
          <div className="scroll-reveal space-y-3">
            ...
            <h2 className="text-4xl sm:text-6xl font-galano font-normal text-[#111111] leading-tight">
              Turning <em className="font-swarsh italic font-normal text-[#111111]">vision</em> into <br />
              <span className="font-galano">reality</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="scroll-reveal lg:col-span-5 rounded-[32px] overflow-hidden relative min-h-[440px] flex flex-col justify-end p-8 sm:p-10 border border-[#DCDAD4] group shadow-sm">
              <img
                src="https://framerusercontent.com/images/Dj4ocCol5pMn5REI6UxlIzJllk.jpg"
                alt="Debo Atiba"
                className="absolute inset-0 w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700 filter grayscale"
              />
            ...
            {/* Right Mission & Goals Content */}
            <div className="scroll-reveal lg:col-span-7 bg-[#F5F4F0] border border-[#DCDAD4] rounded-[32px] p-8 sm:p-12 flex flex-col justify-between space-y-10 shadow-sm">
              
              {/* Mission */}
              <div className="space-y-4">
                <h3 className="text-2xl sm:text-3xl font-galano font-normal text-[#111111]">
                  Our mission
                </h3>
                <p className="text-sm sm:text-base text-[#555555] leading-relaxed font-normal">
                  To empower brands' identity through bold design, strategic thinking, and experiences that inspire action and create lasting impact. To help businesses stand out through thoughtful branding and high-performance identity solutions rooted in creativity and clarity.
                </p>
                <div className="pt-2">
                  <a
                    href="https://wa.me/2349030001851"
              ...
              {/* Goals */}
              <div className="space-y-4 pt-6 border-t border-[#DCDAD4]">
                <h3 className="text-2xl sm:text-3xl font-galano font-normal text-[#111111]">
                  Our goal
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  {goals.map((goal, gIdx) => (
                    <div key={gIdx} className="flex items-center gap-3 bg-white/80 p-3 rounded-2xl border border-[#DCDAD4]/60">
                      <div className="w-6 h-6 rounded-full bg-[#E2B857]/20 text-[#111111] flex items-center justify-center shrink-0">
              ...
              <div className="text-xs text-[#888888] font-mono pt-4">
                © 2026 Identifine
              </div>
            </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Card 1: Experience */}
          <div className="scroll-reveal bg-[#F5F4F0] border border-[#DCDAD4] rounded-[28px] p-8 flex flex-col justify-between min-h-[220px] shadow-sm hover:border-[#111111]/30 transition-all">
            <span className="text-xs font-mono uppercase tracking-widest text-[#666666] font-bold">
              Years of experience
            </span>
            <div className="space-y-2 my-auto py-4">
              <div className="text-5xl sm:text-6xl font-galano font-normal text-[#111111]">
          ...
          {/* Card 2: Clients Worldwide */}
          <div className="scroll-reveal bg-[#F5F4F0] border border-[#DCDAD4] rounded-[28px] p-8 flex flex-col justify-between min-h-[220px] shadow-sm hover:border-[#111111]/30 transition-all">
            <div className="flex items-center justify-between">
              <div className="flex -space-x-2 overflow-hidden">
                <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://framerusercontent.com/images/jm0dvrhBRn67BN7gXkLvk9Ymi4.jpg" alt="" />
                <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://framerusercontent.com/images/rvVsRZjAKkiA0nvOxWWVXzG9L6s.jpg" alt="" />
                <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://framerusercontent.com/images/nSZJQpCu25uRO9lrT3cjUnyKmk.jpg" alt="" />
                <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://framerusercontent.com/images/OmhA69HM1VbnEMV63I5CAKdlNlk.jpg" alt="" />
              </div>
              <span className="text-xs font-bold text-[#E2B857] bg-black px-2.5 py-1 rounded-full">
                98% Retention
              </span>
            </div>
            <div className="space-y-2 my-auto py-4">
              <div className="text-5xl sm:text-6xl font-galano font-normal text-[#111111]">
                <AnimatedNumber target="72" suffix="+" />
              </div>
              <p className="text-xs sm:text-sm text-[#555555]">
                Happy clients worldwide staying for quality.
              </p>
            </div>
          </div>
          ...
          <div className="scroll-reveal bg-[#F5F4F0] border border-[#DCDAD4] rounded-[28px] p-8 flex flex-col justify-between min-h-[220px] shadow-sm hover:border-[#111111]/30 transition-all">
            ...
            <div className="space-y-2 my-auto py-4">
              ...
              <p className="text-xs sm:text-sm text-[#555555]">
                Creative solutions built with purpose.
              </p>
            </div>
          </div>
          ...
          <div className="scroll-reveal bg-[#F5F4F0] border border-[#DCDAD4] rounded-[28px] p-8 flex flex-col justify-between min-h-[220px] shadow-sm hover:border-[#111111]/30 transition-all">
            ...
            <div className="space-y-2 my-auto py-4">
              ...
              <p className="text-xs sm:text-sm text-[#555555]">
                From strategy to standout identity experience.
              </p>
            </div>
          </div>
        ...
        {/* ========================================================= */}
        <section className="pt-8 border-t border-[#DCDAD4]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="scroll-reveal lg:col-span-4 space-y-4">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-galano font-normal text-[#111111] leading-tight">
                Find the <br />
                <em className="font-swarsh italic font-normal text-[#111111]">answers</em>
              </h2>
            </div>
                  ...
                  return (
                    <div key={index} className="border-b border-[#DCDAD4]">
                      <button
                        ...
                        className="w-full flex items-center justify-between text-left py-6 sm:py-8 group focus:outline-none"
                      >
                        <h3 className="text-xl sm:text-2xl font-galano font-normal text-[#111111] group-hover:text-[#E2B857] transition-colors leading-tight pr-8">
                          {faq.question}
                        </h3>
                        <div className="w-10 h-10 rounded-full bg-white group-hover:bg-[#E2B857] text-[#111111] border border-[#DCDAD4] flex items-center justify-center shrink-0 transition-colors shadow-sm">
                          <ChevronDown
                      ...
                      >
                        <div className="overflow-hidden">
                          <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl font-normal">
                            {faq.answer}
                          </p>
                        </div>
                      </div>
