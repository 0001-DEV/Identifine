...
function AnimatedNumber() {
  ...
  return (
    <div ref={counterRef} className="flex items-start justify-center text-[#888888] italic font-galano font-bold text-[2.5rem] sm:text-5xl leading-none tracking-tighter mb-1 sm:mb-2 pt-1 h-10 sm:h-14">
